...
export default defineConfig({
  ...
  projects: [
...

    {
      ...
      testMatch: /testSuite(?!NSEFhappyPATHS|CxoInvoice|NsefCXOtest|IntakeNegative|IntakeListing|NSETracksHotfixes|RFXtests|SupplierPortal|allmodulesrejectedit|InvoiceDisputed|ModuleListings|CrossModuleDocs|Requisition|ActivityTimeline|RFXAnalysis|SaveEditSubmit|Dashboard|SupplierOnboarding|PurchaseOrder|InvoiceAckRules|CxoClone|QaClarified|Reports|AuctionFlow|AllReports|ShortClose|DoubleSubmit|RfxEvaluation|InvoiceVendorRpt|PrEdit|PrcView|SupplierIfsc|GrnCancel|InvoiceMsme|PoAmendBudget|RfxCollab).*\.spec\.js/,
      use: {
    ...
    {
      name: 'nsef-tests',
      testMatch: /testSuite(NSEFhappyPATHS|CxoInvoice|NsefCXOtest|IntakeNegative|IntakeListing|NSETracksHotfixes|RFXtests|allmodulesrejectedit|InvoiceDisputed|ModuleListings|CrossModuleDocs|Requisition|ActivityTimeline|RFXAnalysis|SaveEditSubmit|Dashboard|SupplierOnboarding|PurchaseOrder|InvoiceAckRules|CxoClone|QaClarified|Reports|AuctionFlow|AllReports|ShortClose|DoubleSubmit|RfxEvaluation|InvoiceVendorRpt|PrEdit|PrcView|SupplierIfsc|GrnCancel|InvoiceMsme|PoAmendBudget|RfxCollab)\.spec\.js/,
